...
<div class="modal fade" id="editarPacienteModal" tabindex="-1" aria-labelledby="editarPacienteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editarPacienteForm" action="{{ route('pacientes.storeOrUpdate') }}" method="POST">
            @csrf
            <input type="hidden" id="paciente_id" name="paciente_id">
            <div class="form-group">
                <label for="nombre">Nombre</label>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Lista de pacientes</h6>
                                        ...
                                        @foreach($pacientes as $paciente)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <form id="registrarPacienteForm" action="{{ route('pacientes.storeOrUpdate') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" id="paciente_id" name="paciente_id" value="{{ old('paciente_id', $paciente->id ?? '') }}">
                                                    <div class="form-group">
                                                        <label for="nombre">Nombre</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="edad">Edad</label>
                                                        <input type="number" class="form-control" id="edad" name="edad" value="{{ old('edad', $paciente->edad ?? '') }}" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="sexo">Sexo</label>
                                                        <select class="form-control" id="sexo" name="sexo" required>
